...
var ApiError_1 = __webpack_require__(6); // import { jwtSecret } from './../../config/default.json'
...
var TYPES = {
  ...
  Auth: Symbol('Auth'),
  Room: Symbol('Room'),
  Translate: Symbol('Translate') // Container: Symbol('Container'),
      ...
      var _createBrowser = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                puppeteerNode = puppeteer_1["default"];
                _context3.next = 3;
